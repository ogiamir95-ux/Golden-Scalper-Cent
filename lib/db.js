...
// Hapus PERMANEN data akun EA/MT5 (baris `accounts`) berikut seluruh log
// terkait (via ON DELETE CASCADE di `ea_logs`) dan entri jurnal harian.
// Dipakai bersamaan dengan deleteWebUser() supaya "lisensi" (state,
// license_key_hash, license_expires_at) ikut hilang sepenuhnya dari
// server — begitu EA sync berikutnya, server tidak lagi punya rekam
// jejak validasi lisensi utk akun ini.
